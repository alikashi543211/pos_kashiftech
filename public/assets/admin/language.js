$(document).ready(function () {
    ...
    $(document).on("click", ".btn-add", function (e) {
        ...
        jQuery.getJSON(admin_url + "/language/add/", function (response) {
    ...
    $(document).on("click", ".btn-edit", function (e) {
        $(".modal-body").html("");
        $(".drawer-title").html("Edit Language");
        var id = $(this).data("id");
        console.log('id:', id)
        jQuery.getJSON(
            admin_url + "/language/edit/" +id,
            function (response) {
                if (response.responseCode == 1) {
                    $(".drawer-body").html(response.html);
                    const drawerElement = document.querySelector("#kt_drawer_chat");
    ...
    $(document).on("click", ".btn-status-change", function (e) {
        ...
        var message = 'Are you sure you want to change language status?';
        var statusElement = $(this);
        var updateFundsStatusUrl = admin_url + "/language-update-status";
    ...
    $(document).on("click", ".btn-del", function(e) {
        ...
        var deleteUrl = admin_url + "/language/delete";
        Swal.fire({
            title: 'Are you sure?',
