$(document).ready(function () {
    ...
    $(document).on("click", ".btn-add", function (e) {
        $(".modal-body").html("");
        $(".drawer-title").html("Add New Designation");
        jQuery.getJSON(admin_url + "/designation/add/", function (response) {
    ...
    $(document).on("click", ".btn-edit", function (e) {
        $(".modal-body").html("");
        $(".drawer-title").html("Edit Designation");
        var id = $(this).data("id");
        console.log('id:', id)
        jQuery.getJSON(
            admin_url + "/designation/edit/" +id,
            function (response) {
                if (response.responseCode == 1) {
                    $(".drawer-body").html(response.html);
                    const drawerElement = document.querySelector("#kt_drawer_chat");
    ...
    $(document).on("click", ".btn-status-change", function (e) {
        ...
        var message = 'Are you sure you want to change designation status?';
        var statusElement = $(this);
        var updateFundsStatusUrl = admin_url + "/designation-update-status";
    ...
    $(document).on("click", ".btn-del", function(e) {
        ...
        var deleteUrl = admin_url + "/designation/delete";
        Swal.fire({
            title: 'Are you sure?',
    ...
    //Form 
       ...
       $(document).on("submit", "#fform", function (e) {
        ...
        // loadSpinner();
        $.ajax({
            url: admin_url + "/designation/" + params,
            type: "POST",
