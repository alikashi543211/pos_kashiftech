$(document).ready(function () {
  ...
  $(document).on("click", ".btn-add", function (e) {
        $(".modal-body").html("");
        $(".drawer-title").html("Add New Banner");
        jQuery.getJSON(admin_url + "/banners/add/", function (response) {
    ...
    $(document).on("click", ".btn-edit", function (e) {
        $(".modal-body").html("");
        $(".drawer-title").html("Edit Existing Banner");
        var id = $(this).data("id");
        console.log('id:', id)
        jQuery.getJSON(
            admin_url + "/banners/edit/" +id,
            function (response) {
                if (response.responseCode == 1) {
                    initTinyMCE();
                    $(".drawer-body").html(response.html);
    ...
    $(document).on("click", ".btn-status-change", function (e) {
        ...
        var message = 'Are you sure you want to change banner status?';
        var statusElement = $(this);
        var updateCategoryStatusUrl = admin_url + "/banners/status-change/"+ bannerId;
    ...
    $(document).on("click", ".btn-del", function(e) {
        ...
        var deleteUrl = admin_url + "/banners/delete/"+categoryId;
        Swal.fire({
            title: 'Are you sure?',
