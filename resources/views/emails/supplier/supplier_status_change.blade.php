...
<body>
    <div class="email-container">
        <div class="header">
            <h1>Supplier Status Updated</h1>
        </div>
        <div class="content">
            <h2>Dear {{ @$supplierDetail->supplier_public_name }},</h2>
            <p>We hope this email finds you well.</p>
            <p>Your supplier profile on our platform has been recently updated by our admin team. The changes were made to ensure that your profile is accurate and up-to-date, reflecting the latest information about your business.</p>
            <h3>Details:</h3>
            <ul>
        ...
        <div class="footer">
            ...
            {{-- <p>[Your Company Name] | [Your Contact Information]</p> --}}
        </div>
    </div>
</body>
</html>
