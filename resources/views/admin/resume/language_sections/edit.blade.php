    ...
    <div class="card-body drawer-body" id="kt_drawer_chat_messenger_body">
        ...
        <div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true"
            ...
            <div class="fv-row mb-8">
                ...
                <input type="text" name="language_title" id="language_title" placeholder="Enter language name" value="{{ $row->language_title ?? '' }}"
            ...
            <div class="fv-row mb-8">
                ...
                <select class="form-select form-select-solid" data-control="select2"
                    ...
                    @for ($k = 1; $k <= 5; $k++)
                        <option value="{{ $k }}" @if($row->language_rating == $k) selected @endif>{{ $k }}</option>
                    @endfor
                </select>
            </div>
