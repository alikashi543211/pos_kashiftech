                ...
                <div class="py-3 card-body">
                    <form name="resume_header_sections" enctype="multipart/form-data" id="resume_header_sections_form"
                        ...
                        <div class="mb-8 col-md-12">
                            <label class="mb-2 required fs-6 fw-semibold">Skill Section Text</label>
                            <textarea type="text" name="skill_section_description" id="skill_section_heading"
                                placeholder="Enter skill section description" class="form-control" required>{{ $headerSection->skill_section_description ?? '' }}</textarea>
                        </div>
                    </form>
                    <!--end::Table container-->
                </div>
