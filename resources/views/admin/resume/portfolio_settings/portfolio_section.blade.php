                ...
                <div class="py-3 card-body">
                    <form name="resume_header_sections" enctype="multipart/form-data" id="resume_header_sections_form"
                        ...
                        <div class="mb-8 col-md-12">
                            <label class="mb-2 required fs-6 fw-semibold">Portfolio Section Text</label>
                            <textarea type="text" name="portfolio_section_text" id="portfolio_section_text"
                                placeholder="Enter resume section description" class="form-control" required>{{ $headerSection->portfolio_section_text ?? '' }}</textarea>
                        </div>
                    </form>
                    <!--end::Table container-->
                </div>
