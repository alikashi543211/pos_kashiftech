        ...
        <div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true"
            ...
            <div class="fv-row mb-8">
                ...
                <input type="text" name="category_name" id="category_name" placeholder="Enter category name"
                    value="{{ $row->category_name ?? '' }}" class="form-control" required />
            </div>
            <div class="fv-row mb-8">
                <label class="required fs-6 fw-semibold mb-2">Category Slug</label>
                <input type="text" name="category_slug" id="category_slug" placeholder="Enter category slug"
                    value="{{ $row->category_slug ?? '' }}" class="form-control" required />
            </div>
        </div>
    </div>
