                ...
                <div class="card-header border-0 pt-5">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-user-listing-table-filter="search"
                            class="form-control form-control-solid w-250px ps-13" placeholder="Search Project Category" />
                    </div>
                    <div class="card-toolbar">
                        @if (validatePermissions('resume/project-categories/add'))
                            <a href="javascript:void(0)" class="btn btn-sm btn-primary float-end me-3 btn-add"><i
                                    class="fa-solid fa-plus"></i> Add New Project Category</a>
                        @endif
                    </div>
                </div>
                <!--end::Header-->
                                ...
                                @if ($projectCategories)
                                    @foreach ($projectCategories as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <span title="Change Project Category Status"
...
<script src="{{ asset('/assets/admin') }}/resume_project_categories.js?v={{ time() }}"></script>
@stop
