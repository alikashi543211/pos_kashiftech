    ...
    <div class="card-body drawer-body" id="kt_drawer_chat_messenger_body">
        ...
        <div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true"
                ...
                <div class="text-center col-lg-12">
                    <div class="image-input image-input-outline" data-kt-image-input="true"
                        ...
                        <div class="image-input-wrapper w-125px h-125px" data-type="link-link-thumbnail"
                            style="background-image: url({{ gallery_photo('empty.png', 'avatars') }})"></div>
            ...
            <div class="mb-8 fv-row">
                ...
                <input type="text" name="service_name" id="project_name" placeholder="Enter service name"
            ...
            <div class="mb-8 fv-row">
                ...
                <input type="text" name="service_icon_class" id="service_icon_class"
                    placeholder="Enter service icon class" value="" class="form-control" required />
            </div>
            <div class="mb-8 fv-row">
                ...
                <textarea cols="30" rows="5" maxlength="500" name="description" id="description"
                    placeholder="Enter short description" value="" class="form-control" style="resize: none;"></textarea>
            </div>
            <div class="mb-8 fv-row">
                <label class="mb-2 fs-6 fw-semibold">Sidebar Title</label>
                <input type="text" name="service_sidebar_title" id="service_sidebar_title"
                    placeholder="Enter service sidebar title" value="" class="form-control" />
            </div>
            <div class="mb-8 fv-row">
                ...
                <textarea cols="30" rows="5" maxlength="500" name="service_sidebar_description" id="sidebar_description"
                    placeholder="Enter sidebar description" value="" class="form-control" style="resize: none;"></textarea>
            </div>
        </div>
    </div>
