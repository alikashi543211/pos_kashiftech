    ...
    <div class="card-body drawer-body" id="kt_drawer_chat_messenger_body">
        ...
        <div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true"
            ...
            <div class="row mb-8">
                ...
                <div class="col-lg-12 text-center">
                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('')">
                        <div class="image-input-wrapper w-125px h-125px" data-type="skill-icon" style="background-image: url({{ $row->skill_icon ?? gallery_photo('empty.png','avatars') }})"></div>
            ...
            <div class="fv-row mb-8">
                ...
                <input type="text" name="skill_title" id="skill_title" placeholder="Enter skill name" value="{{ $row->skill_title ?? '' }}"
            ...
            <div class="fv-row mb-8">
                ...
                <select class="form-select form-select-solid" data-control="select2"
                    ...
                    @for ($k = 1; $k <= 100; $k++)
                        <option value="{{ $k }}" @if($row->skill_rating == $k) selected @endif>{{ $k }}</option>
                    @endfor
                </select>
            </div>
