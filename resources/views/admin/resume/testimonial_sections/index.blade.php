        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-user-listing-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search Testimonials" />
                </div>
                <div class="card-toolbar">
                    @if (validatePermissions('resume/testimonial-sections/add'))
                        <a href="javascript:void(0)" class="btn btn-sm btn-primary float-end me-3 btn-add"><i class="fa-solid fa-plus"></i> Add New Testimonial</a>
                    @endif
                </div>
            </div>
            <!--end::Header-->
                    ...
                    <table id="datatableusr" class="table table-hover table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                        <thead>
                            <tr class="fw-bold text-muted">
                                <th class="min-w-150px">User Image</th>
                        ...
                        <tbody>
                            @if ($testimonials)
                                @foreach ($testimonials as $row)
                                    <tr>
                                        <td>
                                            <img src="{{ $row->display_picture }}" width="50" height="50" alt="">
                                        </td>
                                        <td>
                                            {{ $row->full_name ?? '-----' }}
                                        </td>
...
<script src="{{ asset('/assets/admin') }}/resume_testimonial_sections.js?v={{ time() }}"></script>
@stop
