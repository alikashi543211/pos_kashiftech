    ...
    <div class="card-body drawer-body" id="kt_drawer_chat_messenger_body">
        ...
        <div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true"
            ...
            <div class="row mb-8">
                ...
                <div class="col-lg-12 text-center">
                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('')">
                        <div class="image-input-wrapper w-125px h-125px" data-type="link-link-thumbnail" style="background-image: url({{ $row->display_picture ?? gallery_photo('empty.png','avatars') }})"></div>
            ...
            <div class="fv-row mb-8">
                ...
                <input type="text" name="full_name" id="full_name" placeholder="Enter user full name" value="{{ $row->full_name ?? '' }}"
                    class="form-control" required />
            </div>
            <div class="fv-row mb-8">
                <label class="required fs-6 fw-semibold mb-2">Designation</label>
                <input type="text" name="designation_title" id="designation" placeholder="Enter designation" value="{{ $row->designation_title ?? '' }}"
                    class="form-control" required />
            </div>
            <div class="fv-row mb-8">
