...
<form name="fform" enctype="multipart/form-data" id="fform" method="post" action="">
    ...
    <div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true"
        ...
        <div class="fv-row mb-8">
            ...
            <input type="text" name="degree_name" id="degree_name" placeholder="Enter degree name" value=""
                class="form-control" required />
        </div>
        <div class="fv-row mb-8">
            <label class="required fs-6 fw-semibold mb-2">Institute Name</label>
            <input type="text" name="institute_name" id="institute_name" placeholder="Enter institute name" value=""
                class="form-control" required />
        </div>
        <div class="fv-row mb-8">
        ...
        <div class="fv-row mb-8">
            ...
            <input type="text" name="grades" id="grades" placeholder="Enter grades i.e A+ or 900/1100 etc..." value=""
                class="form-control" required />
        </div>
        <div class="fv-row mb-8">
            <label class="required fs-6 fw-semibold mb-2">Description</label>
            <textarea cols="30" rows="3" maxlength="150" name="description" id="description" placeholder="Enter description" value=""
