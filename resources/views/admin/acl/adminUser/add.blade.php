    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-4">
            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('')">
                <div data-display-image="true" class="image-input-wrapper w-125px h-125px" style="background-image: url({{photo('empty.png','avatars')}})"></div>
                <label for="user-avatar-image" class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                    data-kt-image-input-action="change" data-bs-toggle="tooltip" title=""
                    data-bs-original-title="Change avatar">
                    <i class="bi bi-pencil-fill fs-7"></i>
                    <input type="file" data-type="file" id="user-avatar-image" name="avatar" accept=".png, .jpg, .jpeg">
            ...
            <div class="card border-1">
                ...
                <div class="card-body">
                    ...
                    <div class="fv-row mb-8">
                        ...
                        <input type="text" name="mobile_number" placeholder="Phone / Mobile" id="mobile_number" value=""
                            class="form-control" />
                    </div>
                    <div class="fv-row mb-8">
                        ...
                        <select class="form-select form-select-solid" data-control="select2"
                            ...
                            @if ($countries)
                                @foreach ($countries as $dep)
                                    <option value="{{ $dep->country_id }}">{{ $dep->name }}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
                        ...
                        <select class="form-select form-select-solid" data-control="select2"
                            ...
                            @if ($cities)
                                @foreach ($cities as $dep)
                                    <option value="{{ $dep->city_id }}">{{ $dep->city_name }}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
            ...
            <div class="card border-1">
                ...
                <div class="card-body">
                    <div class="fv-row mb-8">
                        ...
                        <input type="text" name="user_name" placeholder="User Name" id="user_name" value=""
                            class="form-control" required />
                    </div>
                    <div class="fv-row mb-8">
                        ...
                        <select class="form-select form-select-solid" data-control="select2"
                            ...
                            @if ($reportsTo)
                                @foreach ($reportsTo as $dep)
                                    <option value="{{ $dep->user_name }}">{{ $dep->employee->FullName ?? '' }}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
