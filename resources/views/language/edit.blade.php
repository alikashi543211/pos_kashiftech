<form name="fform" enctype="multipart/form-data" id="fform" method="post" action="">
    ...
    <div class="card-body drawer-body" id="kt_drawer_chat_messenger_body">
        ...
        <input type="hidden" name="eid" id="eid" value="{{ base64_encode($row->id) }}">
        <div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true"
            ...
            <div class="fv-row mb-8">
                <label class="required fs-6 fw-semibold mb-2">Language Title</label>
                <input type="text" name="name" placeholder="Enter language title" id="name"
                    value="{{ $row->name }}" class="form-control" required />
            </div>
            <div class="fv-row mb-8">
                <label class="required fs-6 fw-semibold mb-2">Short Code</label>
                <input type="text" name="short_code" placeholder="Enter short code" id="short_code"
                    value="{{ $row->short_code }}" class="form-control" required />
            </div>
